...
# added to the build
#
COMPONENTS=FREERTOS MBEDTLS LWIP SECURE_SOCKETS PSOC6HAL EMWIN_OSNTS
...
CY_IGNORE= $(SEARCH_cJSON)/fuzzing $(SEARCH_cJSON)/library_config $(SEARCH_cJSON)/tests $(SEARCH_cJSON)/test.c
